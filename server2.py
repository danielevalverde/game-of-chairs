...
def send_chairs():
    ...
    message = "QTD_CADEIRAS=" + str(num_chairs)
...
def handle_client(conn):
    try:
            ...
            if len(players) == players_ready:
                if not is_music_playing:
                    ...
                    if music_stopped:
                        ...
                        num_cadeira = int(data)
                        chairs[num_cadeira - 1] = 'o'
        ...
        print("Ocorreu um erro ao processar a mensagem do jogador:", conn.getpeername())
